            ...
            {this.props.buttonOnly
                ...
                : [
                    <div key={'import-file-prefix'} className='import-file-prefix row'>
                        {this.state.preview ? this.state.preview.type?.includes('image') ? <img alt='' src={this.state.preview instanceof File ? URL.createObjectURL(this.state.preview) : this.state.preview.url} /> : fileSvg : cloudSvg}
                    </div>,
