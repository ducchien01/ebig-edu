...
export function ProgressBar({ status = ComponentStatus.INFOR, percent = 100, titleText, title, hideTitle = false, progressBarOnly = false, fullColor = 'var(--background)', percentColor = 'var(--primary-color)', style, progressBarStyle }: {
    percent: number,
    titleText?: string,
    title?: ReactNode,
    hideTitle: boolean,
