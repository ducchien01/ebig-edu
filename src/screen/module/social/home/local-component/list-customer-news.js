...
import { InfiniteScroll, Text, closePopup, showPopup } from "../../../../../component/export-component"
...
export default function ListCustomerNews({ customer, newStatus = NewStatus.published, onScroll }) {
    const ref = useRef()
